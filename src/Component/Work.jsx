         ...
         <div className="work" id="work">
                ...
                <div className="work bd-grid">
                    <div className="work__img">
                        {/* <img src="hot.png" alt=""/> */}
                        <a href="https://ibb.co/wsm3rPY"><img src="https://i.ibb.co/L57bhcv/hot.png" alt="hot" border="0"/></a>
                   ...
                   <div className="work__img">
                      ...
                      <a href="https://ibb.co/ysXqLPX"><img src="https://i.ibb.co/VBtTX9t/hirist.png" alt="hirist" border="0"/></a>
                     ...
                     <div className="work__img">
                   <a href="https://ibb.co/Vgb1NDM"><img src="https://i.ibb.co/McKvhpP/my-Port-Folio.png" alt="my-Port-Folio" border="0"/></a>
